...
CREATE TABLE subscription (
    ...
    CONSTRAINT ck_subscription_current_marker CHECK (current_marker IS NULL OR current_marker = TRUE),
...
CREATE TABLE interview_session (
    ...
    feedback_generation_tier VARCHAR(16),
    feedback_generation_task_id UUID,
